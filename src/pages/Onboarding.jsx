  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="bg-white border border-gray-200 rounded-xl shadow-md p-8 text-center overflow-hidden">
          <div className="transition-all duration-500 ease-in-out">
            <div className="text-6xl mb-4 select-none animate-pulse">{slides[idx].icon}</div>
            <h2 className="text-xl font-semibold text-gray-900">{slides[idx].title}</h2>
          </div>
        ...
        <p className="text-center text-xs text-gray-500 mt-4">You can change this later in settings.</p>
      </div>
    </div>
  );
}
